...
def do_zip_update():
    ...
    if response.status_code == 200:
        ...
        try:
            ...
            mesgdcrt.FailureMessage("Error ocuured while extracting !!")
    if success:
        mesgdcrt.SuccessMessage("HBomb was updated to the latest version")
        mesgdcrt.GeneralMessage(
            "Please run the script again to load the latest version")
    else:
        mesgdcrt.FailureMessage("Unable to update HBomb.")
        mesgdcrt.WarningMessage(
            "Grab The Latest one From https://github.com/HorridHanu/HBomb.git")
...
def do_git_update():
    ...
    if success:
        ...
        print(
            "git checkout . && "
            "git pull https://github.com/HorridHanu/HBomb.git HEAD")
    sys.exit()
...
def check_for_updates():
    ...
    if fver != __VERSION__:
        ...
        mesgdcrt.SuccessMessage("HBomb is up-to-date")
        mesgdcrt.GeneralMessage("Starting HBomb")
...
def pretty_print(cc, target, success, failed):
    ...
    mesgdcrt.SuccessMessage("HBomb was created by Horrid Hanu")
...
def workernode(mode, cc, target, count, delay, max_threads):
    ...
    mesgdcrt.GeneralMessage("Delay         : " + str(delay) +
                            " seconds")
    mesgdcrt.WarningMessage(
        "This tool was made for fun and research purposes only don't try to miss use.")
    print()
...
HBomb is not intented for malicious uses.
"""
